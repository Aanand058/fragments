...
async function deleteFragment(ownerId, id) {
  ...
  try {
    ...
    const { Bucket, Key } = params;
    logger.error({ err, Bucket, Key }, 'Error deleting fragments data from S3');
    throw new Error('Unable to delete fragments data', err.message);
  }
}
